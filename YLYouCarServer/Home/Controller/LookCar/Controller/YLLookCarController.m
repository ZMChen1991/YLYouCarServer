...
@interface YLLookCarController ()

@property (nonatomic, strong) NSMutableArray *allOrders;

@end

@implementation YLLookCarController
...
- (void)loadData {
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/buy?method=lists", YLCommandUrl];
